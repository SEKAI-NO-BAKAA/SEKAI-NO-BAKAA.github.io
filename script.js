...
//   convertir la chaine de caractères en entrée en chaine de caractère en minuscule
 ...
 if  ( a == "loli" ||  a==="lolii" ){
    ...
    window.open("page Merci.html","_self") ;
